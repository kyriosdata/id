...
DROP TABLE IF EXISTS OBITOFONTE;
DROP TABLE IF EXISTS RACA;
DROP TABLE IF EXISTS SEXO;
DROP TABLE IF EXISTS SITUACAOFAMILIAR;
DROP TABLE IF EXISTS DATASEGUIMENTO;
DROP TABLE IF EXISTS NASCIMENTOORDEM;
DROP TABLE IF EXISTS NASCIMENTOPLURALIDADE;
DROP TABLE IF EXISTS CERTIDAOTIPO;
DROP TABLE IF EXISTS IDENTIFICADORTIPO;
DROP TABLE IF EXISTS COMUNICACAOMEIO;
DROP TABLE IF EXISTS COMUNICACAOPREFERENCIA;
DROP TABLE IF EXISTS COMUNICACAOUSO;
DROP TABLE IF EXISTS RELACIONAMENTOTIPO;
DROP TABLE IF EXISTS NOMEPREFERIDO;
DROP TABLE IF EXISTS USOCONDICIONAL;
DROP TABLE IF EXISTS NOMEUSO;
DROP TABLE IF EXISTS ENDERECOTIPO;
...
INSERT INTO AREAGEOGRAFICA VALUES
  (1, 'L', 'Identificador do sujeito local'),
  (2, 'A', 'Identificador da área/região/distrito'),
  (3, 'E', 'Identificador do estado/província/território'),
  (4, 'N', 'Identificador nacional');
 ...
 */
CREATE TABLE CERTIDAOTIPO (
  codigo    INT,
  descricao VARCHAR,
  PRIMARY KEY (codigo)
);

INSERT INTO CERTIDAOTIPO VALUES
  (1, 'nascimento'),
  (2, 'casamento'),
  (3, 'divórcio');
...
INSERT INTO IDENTIFICADORTIPO VALUES
  ('10', 'SSP'),
